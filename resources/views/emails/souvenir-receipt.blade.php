        ...
        <tr>
            <td align="center">
                ...
                <table width="650" cellpadding="0" cellspacing="0" border="0"
                       style="max-width:650px; width:100%; background-color:#ffffff; border-radius:8px; overflow:hidden;">

                    <!-- HEADER -->
                    <tr>
                        <td style="padding:15px 25px; border-bottom:1px solid #eeeeee;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" valign="middle">
                                        <div style="font-size:14px; font-weight:bold; color:#005baa;">
                                            {{ $senderName }}
                                        </div>
                                    </td>
                    ...
                    <tr>
                        <td style="padding:35px 35px 15px 35px;">
                            ...
                            <div style="font-size:24px; font-weight:bold; color:#222222;">
                                Tanda Terima Pengambilan Souvenir
                            </div>

                            <div style="height:4px; width:55px; background-color:#005baa; margin-top:12px;"></div>
                    ...
                    <!-- GREETING -->
                    <tr>
                        <td style="padding:10px 35px 20px 35px; font-size:15px; line-height:1.7;">

                            <p style="margin:0 0 15px 0;">
                                Yth. <strong>{{ $receipt->participant->name }}</strong>,
                            </p>

                            <p style="margin:0;">
                                Terima kasih telah hadir dan berpartisipasi dalam kegiatan
                                <strong>{{ $receipt->participant->event->name ?? '-' }}</strong>.
                            </p>
                    ...
                    <tr>
                        <td style="padding:10px 35px 10px 35px;">
                            ...
                            <div style="font-size:17px; font-weight:bold; color:#222222; margin-bottom:12px;">
                                Detail Peserta
                            </div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td width="180" style="padding:8px 0; color:#666666;">
                                        Participant ID
                                    </td>
                    ...
                    <tr>
                        <td style="padding:25px 35px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                   style="border-collapse:collapse; background-color:#f7f9fb;">
                                ...
                                @foreach ($receipt->receiptItems as $receiptItem)
                                    ...
                                    <tr>
                                        <td style="padding:12px 15px; border-bottom:1px solid #e5e5e5;">
                                            ...
                                            <span style="color:#20a464; font-weight:bold;">
                                                ✓
                                            </span>
                    ...
                    <tr>
                        <td style="padding:0 35px 25px 35px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                   style="background-color:#eef6ff; border-left:4px solid #005baa;">

                                <tr>
                                    <td style="padding:15px 18px; font-size:13px; line-height:1.6; color:#555555;">
                    ...
                    <!-- CLOSING -->
                    <tr>
                        <td style="padding:5px 35px 35px 35px; font-size:14px; line-height:1.7;">
                            ...
                            <p style="margin:5px 0 0 0; font-weight:bold; color:#005baa;">
                                {{ $senderName }}
                            </p>

                            <p style="margin:2px 0 0 0; color:#777777;">
                    ...
                    <tr>
                        <td align="center"
                            style="padding:18px 25px; background-color:#f1f3f5; font-size:11px; color:#888888;">
